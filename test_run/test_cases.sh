...
# ============================================================================
. /workspace/test_run/test_harness.sh
...
# Run, then check
"$TEST_ROOT/backup.sh" >/dev/null 2>&1
...
"$TEST_ROOT/backup.sh" >/tmp/t27_stdout 2>/tmp/t27_stderr &
_pid=$!
sleep 0.5
...
BACKUP_DIR="./backup"
'
"$TEST_ROOT/backup.sh" >/tmp/t28_stdout 2>/tmp/t28_stderr &
_pid=$!
sleep 0.5
...
BACKUP_DIR="./backup"
'
"$TEST_ROOT/backup.sh" >/tmp/t29_stdout 2>/tmp/t29_stderr &
_pid=$!
sleep 0.5
